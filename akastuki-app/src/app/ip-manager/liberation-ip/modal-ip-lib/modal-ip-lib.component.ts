...
@Component({
  selector: 'app-modal-ip-lib',
  templateUrl: './modal-ip-lib.component.html',
  styleUrls: ['./modal-ip-lib.component.scss']
})
export class ModalIpLibComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalIpLibComponent>,
  ...
  onSubmit(param?: any){
    let methode= 'ip/liberationAddress'
