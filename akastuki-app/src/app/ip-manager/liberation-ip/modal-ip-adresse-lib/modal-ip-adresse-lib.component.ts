...
@Component({
  selector: 'app-modal-ip-adresse-lib',
  templateUrl: './modal-ip-adresse-lib.component.html',
  styleUrls: ['./modal-ip-adresse-lib.component.scss']
})
export class ModalIpAdresseLibComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalIpAdresseLibComponent>,
