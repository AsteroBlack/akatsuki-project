...
@Component({
  selector: 'app-modal-setup-ip-lib',
  templateUrl: './modal-setup-ip-lib.component.html',
  styleUrls: ['./modal-setup-ip-lib.component.scss']
})
export class ModalSetupIpLibComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalSetupIpLibComponent>,
