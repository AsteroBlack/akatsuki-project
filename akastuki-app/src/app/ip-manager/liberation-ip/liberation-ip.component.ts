...
@Component({
  selector: 'app-liberation-ip',
  templateUrl: './liberation-ip.component.html',
  styleUrls: ['./liberation-ip.component.scss']
})
export class LiberationIpComponent implements OnInit {
  ...
  rechercher(){
    ...
    if(this.searchData.nb.trim().length>0){
      this.dialog.open(ModalIpAdresseLibComponent, {
        width: '600px',
        disableClose: true,
  ...
  ajout(item: any){
    ...
    const dialogRef = this.dialog.open(ModalGenerateAdresseLibComponent, {
      width: '600px',
      disableClose: true,
      data: item
    });
  ...
  edit(item: any){
    ...
    const dialogRef = this.dialog.open(ModalSetupIpLibComponent, {
      width: '600px',
      disableClose: true,
      data: item
    });
  ...
  getIp() {
    ...
    const methode = 'client/getByCriteriaLite';
  ...
  openModal(param?: any, idIp?:any){
    const dialogRef = this.dialog.open(ModalIpLibComponent, {
      width: '600px',
      disableClose: true,
      data: [param,idIp] ,
    });
  ...
  ipPoolDetails(elt: any){
    const dialogRef = this.dialog.open(ModalDetailPoolLibComponent, {
      width: '600px',
      disableClose: true,
      data: elt
    });
