...
@Component({
  selector: 'app-modal-generate-adresse',
  templateUrl: './modal-generate-adresse.component.html',
  styleUrls: ['./modal-generate-adresse.component.scss']
})
export class ModalGenerateAdresseComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  jsTreeElt: any;
  listeClient : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalGenerateAdresseComponent>,
