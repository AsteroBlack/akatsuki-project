...
@Component({
  selector: 'app-modal-detail-pool',
  templateUrl: './modal-detail-pool.component.html',
  styleUrls: ['./modal-detail-pool.component.scss']
})
export class ModalDetailPoolComponent implements OnInit, AfterContentInit {
  // formModal: FormGroup;
  pagePool: any = {
    index: 0,
    size: 10,
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalDetailPoolComponent>,
