...
declare var $: any;
@Component({
  selector: 'app-modal-attributs',
  templateUrl: './modal-attributs.component.html',
  styleUrls: ['./modal-attributs.component.scss']
})
export class ModalAttributsComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  jsTreeElt: any;
  listeZone : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalAttributsComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any) {
      this.formModal = new FormGroup({
        id: new FormControl(null),
        value: new FormControl(null),
        type: new FormControl(null, [Validators.required]),
        attribut: new FormControl(null, [Validators.required]),
      });
    }
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'attribut/update';
    } else {
        methode = 'attribut/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
