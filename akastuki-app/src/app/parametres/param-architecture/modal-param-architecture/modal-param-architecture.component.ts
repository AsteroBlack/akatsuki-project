...
declare var $: any;
@Component({
  selector: 'app-modal-param-architecture',
  templateUrl: './modal-param-architecture.component.html',
  styleUrls: ['./modal-param-architecture.component.scss']
})
export class ModalParamArchitectureComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamArchitectureComponent>,
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'paramArchitecture/update';
    } else {
        methode = 'paramArchitecture/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
