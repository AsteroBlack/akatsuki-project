...
declare var $: any;
@Component({
  selector: 'app-modal-secteur',
  templateUrl: './modal-secteur.component.html',
  styleUrls: ['./modal-secteur.component.scss']
})
export class ModalSecteurComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalSecteurComponent>,
