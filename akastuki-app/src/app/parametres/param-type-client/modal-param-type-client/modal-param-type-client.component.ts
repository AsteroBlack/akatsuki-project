...
declare var $: any;
@Component({
  selector: 'app-modal-param-type-client',
  templateUrl: './modal-param-type-client.component.html',
  styleUrls: ['./modal-param-type-client.component.scss']
})
export class ModalParamTypeClientComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamTypeClientComponent>,
