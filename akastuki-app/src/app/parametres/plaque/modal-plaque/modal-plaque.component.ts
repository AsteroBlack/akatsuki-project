...
declare var $: any;
@Component({
  selector: 'app-modal-plaque',
  templateUrl: './modal-plaque.component.html',
  styleUrls: ['./modal-plaque.component.scss']
})
export class ModalPlaqueComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  listeCluster : any[] = [];
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalPlaqueComponent>,
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'plaque/update';
    } else {
        methode = 'plaque/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
      user: /*this.userGetData ? this.userGetData.id : */ '1118',
      serviceLibelle: `${this.formModal.value.id ? 'Mise à jours' : 'Création'} de plaque`,
