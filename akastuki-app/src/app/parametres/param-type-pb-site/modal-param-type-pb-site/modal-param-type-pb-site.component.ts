...
declare var $: any;
@Component({
  selector: 'app-modal-param-type-pb-site',
  templateUrl: './modal-param-type-pb-site.component.html',
  styleUrls: ['./modal-param-type-pb-site.component.scss']
})
export class ModalParamTypePbSiteComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamTypePbSiteComponent>,
