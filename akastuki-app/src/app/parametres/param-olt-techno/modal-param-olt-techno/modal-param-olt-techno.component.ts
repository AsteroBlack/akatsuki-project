...
declare var $: any;
@Component({
  selector: 'app-modal-param-olt-techno',
  templateUrl: './modal-param-olt-techno.component.html',
  styleUrls: ['./modal-param-olt-techno.component.scss']
})
export class ModalParamOltTechnoComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamOltTechnoComponent>,
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'paramOltTehno/update';
    } else {
        methode = 'paramOltTehno/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
