...
@Component({
  selector: 'app-param-etat',
  templateUrl: './param-etat.component.html',
  styleUrls: ['./param-etat.component.scss']
})
export class ParamEtatComponent implements OnInit {
  page: any = {
    index: 0,
    size: 10,
    total: 0
  ...
  rechercher(){
    this.getParamsEtat(this.searchData);
  }
  ...
  openModal(param?: any){
    const dialogRef = this.dialog.open(ModalParamEtatComponent, {
      width: '600px',
      disableClose: true,
      data: param
    });
  ...
  deleteAction(param?: any) {
    const methode = 'paramEtat/delete';
    const data = {
