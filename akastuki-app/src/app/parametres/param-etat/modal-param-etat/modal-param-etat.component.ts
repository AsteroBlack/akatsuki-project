...
declare var $: any;
@Component({
  selector: 'app-modal-param-etat',
  templateUrl: './modal-param-etat.component.html',
  styleUrls: ['./modal-param-etat.component.scss']
})
export class ModalParamEtatComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamEtatComponent>,
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'paramEtat/update';
    } else {
        methode = 'paramEtat/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
