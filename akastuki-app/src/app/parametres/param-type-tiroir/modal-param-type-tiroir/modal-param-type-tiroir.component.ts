...
declare var $: any;
@Component({
  selector: 'app-modal-param-type-tiroir',
  templateUrl: './modal-param-type-tiroir.component.html',
  styleUrls: ['./modal-param-type-tiroir.component.scss']
})
export class ModalParamTypeTiroirComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamTypeTiroirComponent>,
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'paramTypeTiroir/update';
    } else {
        methode = 'paramTypeTiroir/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
