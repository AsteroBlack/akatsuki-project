...
export class ActionsComponent implements OnInit {
  ...
  getActions() {
    ...
    const data = {
      serviceLibelle: `Consultation de la liste des actions`,
      ndCode: '',
      customerCode: '',
      ...
      data: {
        ...
        menusId: this.searchData.menusId ?? '',
    ...
    this.restApi.execute(methode, data).subscribe((res: any) => {
      if (res && !res.hasError) {
        this.listeActions = res && res.items ? res.items : [];
  ...
  testMenu(action:string){
    return this.userService.checkMenuExiste('ADMINISTRATION','ACTION',action)
  }
}
