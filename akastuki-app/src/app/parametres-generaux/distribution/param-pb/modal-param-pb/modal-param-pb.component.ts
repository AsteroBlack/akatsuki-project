...
@Component({
  selector: 'app-modal-param-pb',
  templateUrl: './modal-param-pb.component.html',
  styleUrls: ['./modal-param-pb.component.scss']
})
export class ModalParamPbComponent implements OnInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamPbComponent>,
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'paramPb/update';
    } else {
        methode = 'paramPb/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
