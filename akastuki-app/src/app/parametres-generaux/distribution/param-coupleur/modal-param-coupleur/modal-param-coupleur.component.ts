...
declare var $: any;
@Component({
  selector: 'app-modal-param-coupleur',
  templateUrl: './modal-param-coupleur.component.html',
  styleUrls: ['./modal-param-coupleur.component.scss']
})
export class ModalParamCoupleurComponent implements OnInit, AfterContentInit {
  formModal: FormGroup;
  nomFichier: string = '';
  listTypeOffre : any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalParamCoupleurComponent>,
  ...
  onSubmit(param: any){
    ...
    if(this.formModal.value.id){
        methode = 'paramCoupleur/update';
    } else {
        methode = 'paramCoupleur/create';
    }
    const data = {
      ndCode: '',
      customerCode: '',
